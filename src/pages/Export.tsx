                                    ...
                                    <div className="flex gap-3 p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                                        {["#ef4444", "#f59e0b", "#10b981", "#3b82f6"].map(c => (
                                            <button
                                                ...
                                                title={`Filtrar por cor: ${c}`}
                                                className={cn(
                                                    "w-9 h-9 rounded-xl border-2 transition-all relative overflow-hidden",
                                                    selectedColor === c ? 'border-slate-900 scale-110 shadow-lg' : 'border-transparent opacity-20 hover:opacity-100'
                                                )}
                                            >
