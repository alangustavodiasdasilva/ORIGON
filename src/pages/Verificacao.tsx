...
export default function Verificacao() {
                    ...
                    jsonData.forEach((row, index) => {
                        ...
                        if (ref !== 'N/A') {
                            ...
                            parsedAnalises.push({
                                ...
                                amostraId: ref,
                                hvi: (() => {
                                    const raw = String(getVal(["hvi", "inst", "máquina", "maquina"]) || "1").trim();
                                    const num = parseInt(raw, 10);
                                    return (!isNaN(num) && num >= 1 && num <= 7) ? String(num) : "1";
                                })(),
                                data: dataAnalise,
    ...
    const VALID_MACHINES = new Set(['1', '2', '3', '4', '5', '6', '7']);
    const maquinasHVI = Array.from(new Set(analises.map(a => a.hvi))).filter(hvi => hvi && VALID_MACHINES.has(hvi.trim())).sort();
