                            ...
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="bg-white border-b border-neutral-200">
                                        ...
                                        <th className="px-4 py-3 text-center font-bold text-xs uppercase tracking-wider text-neutral-500 w-1/6">MIC</th>
                                        <th className="px-4 py-3 text-center font-bold text-xs uppercase tracking-wider text-neutral-500 w-1/6">LEN</th>
                                        <th className="px-4 py-3 text-center font-bold text-xs uppercase tracking-wider text-neutral-500 w-1/6">UNF</th>
                                        <th className="px-4 py-3 text-center font-bold text-xs uppercase tracking-wider text-neutral-500 w-1/6">STR</th>
                                        <th className="px-4 py-3 text-center font-bold text-xs uppercase tracking-wider text-neutral-500 w-1/6">RD</th>
                                        <th className="px-4 py-3 text-center font-bold text-xs uppercase tracking-wider text-neutral-500 w-1/6">+B</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {/* ROW A - Original */}
                                    <tr className="border-b border-neutral-100 hover:bg-blue-50/30 transition-colors">
                                        ...
                                        <td className="px-4 py-3 text-center font-bold text-base text-blue-600">{typeof originalSample.mic === 'number' ? originalSample.mic.toFixed(2) : (originalSample.mic || '-')}</td>
                                        <td className="px-4 py-3 text-center font-bold text-base text-blue-600">{typeof originalSample.len === 'number' ? originalSample.len.toFixed(2) : (originalSample.len || '-')}</td>
                                        <td className="px-4 py-3 text-center font-bold text-base text-blue-600">{typeof originalSample.unf === 'number' ? originalSample.unf.toFixed(1) : (originalSample.unf || '-')}</td>
                                        <td className="px-4 py-3 text-center font-bold text-base text-blue-600">{typeof originalSample.str === 'number' ? originalSample.str.toFixed(1) : (originalSample.str || '-')}</td>
                                        <td className="px-4 py-3 text-center font-bold text-base text-blue-600">{typeof originalSample.rd === 'number' ? originalSample.rd.toFixed(1) : (originalSample.rd || '-')}</td>
                                        <td className="px-4 py-3 text-center font-bold text-base text-blue-600">{typeof originalSample.b === 'number' ? originalSample.b.toFixed(1) : (originalSample.b || '-')}</td>
                                    </tr>
                                    {/* ROW B - Generated */}
                                    <tr className="hover:bg-green-50/30 transition-colors">
                                        ...
                                        <td className="px-4 py-3 text-center font-bold text-base text-green-600">{generatedValues.mic.toFixed(2)}</td>
                                        <td className="px-4 py-3 text-center font-bold text-base text-green-600">{generatedValues.len.toFixed(2)}</td>
                                        <td className="px-4 py-3 text-center font-bold text-base text-green-600">{generatedValues.unf.toFixed(1)}</td>
                                        <td className="px-4 py-3 text-center font-bold text-base text-green-600">{generatedValues.str.toFixed(1)}</td>
                                        <td className="px-4 py-3 text-center font-bold text-base text-green-600">{generatedValues.rd.toFixed(1)}</td>
                                        <td className="px-4 py-3 text-center font-bold text-base text-green-600">{generatedValues.b.toFixed(1)}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                    ...
                                    <tbody className="divide-y divide-neutral-100">
                                        {editableReadings.mic?.map((_, idx) => (
                                            <tr key={idx} className="hover:bg-blue-50/30 transition-colors">
                                                <td className="px-4 py-2 text-center font-bold text-neutral-400 border-r border-neutral-200 bg-neutral-50">
                                                    {idx + 1}
                                                </td>
                                        ...
                                        {editableReadings.mic && editableReadings.mic.length > 0 && (
                                            <tr className="bg-neutral-100 font-bold border-t-2 border-neutral-300">
                                                <td className="px-4 py-3 text-center text-[10px] uppercase tracking-widest text-neutral-600 border-r border-neutral-300">
                                                    MÉDIA
                                                </td>
                                                {['mic', 'len', 'unf', 'str', 'rd', 'b'].map(field => {
                                                    ...
                                                    const maxDecimals = (field === 'mic' || field === 'len') ? 2 : 1;
                                                    return (
                                                        <td key={field} className="px-2 py-3 text-center text-blue-700 border-r border-neutral-300 last:border-0">
